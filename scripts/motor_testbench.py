...
class CubemarsController:
    ...
    def bringup_to_state(self, target="active"):
        while rclpy.ok():
            ...
            if state == "unconfigured":
                ...
                time.sleep(0.2)
            logging.info(f"Lifecycle state: {self._get_state()}")
